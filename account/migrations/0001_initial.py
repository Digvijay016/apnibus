    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rejection_reson', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('pos_given_as', models.CharField(choices=[('Demo', 'Demo'), ('Sold', 'Sold')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hindi_name', models.CharField(max_length=255, null=True)),
                ('owner', models.CharField(max_length=255, null=True)),
                ('mobile', models.CharField(db_index=True, max_length=20, null=True)),
                ('address', models.CharField(max_length=255, null=True)),
                ('town', models.CharField(default='', max_length=255, null=True)),
                ('gstin', models.CharField(blank=True, max_length=20, null=True)),
                ('pan_number', models.CharField(blank=True, max_length=20, null=True)),
