    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pan_photo', models.FileField(blank=True, null=True, upload_to='operator/')),
                ('aadhar_number', models.CharField(blank=True, max_length=20, null=True)),
                ('aadhar_front_photo', models.FileField(blank=True, null=True, upload_to='operator/')),
                ('aadhar_back_photo', models.FileField(blank=True, null=True, upload_to='operator/')),
