    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('verification pending', 'verification pending'), ('verified', 'verified'), ('rejected', 'rejected')], default='verification pending', max_length=225)),
