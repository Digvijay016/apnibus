...
#         print("###########", bus)
#         from_town = request.data.get('from_town')
#         print("###########", from_town)
#         # to_town = request.data.get('to_town')

#         if BusRoute.objects.filter(bus=bus, start_time__contains=start_time).exists():
#             print("$$$$$$$$ In $$$$$$$$$$$")
...
#         route_ids_list = Route.objects.filter(from_town=from_town)
#         # print("$$$$$$$$$$$$$",route_ids_list)
#         request.data['route_ids'] = route_ids_list
#         # towns_list = []

#         # for route in route_ids_list:
#         #     if RouteTown.filter(route = route).exists():
#         #         towns_list = RouteTown.filter(route=route, to_town=to_town)
