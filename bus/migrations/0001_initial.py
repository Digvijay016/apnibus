    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pos_serial_no', models.CharField(blank=True, max_length=255, null=True)),
                ('pos_dsn_number', models.CharField(blank=True, max_length=255, null=True)),
                ('gps_sim_image', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arrival_time', models.TimeField(default='00:00:00')),
                ('name', models.CharField(max_length=255, null=True)),
                ('route_return_type', models.CharField(choices=['Today', 'Alternate'], default='Select', max_length=20)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
