    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gps_sim_image', models.ImageField(blank=True, max_length=255, null=True, upload_to='')),
                ('operator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='account.operator')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False)),
                ('id', models.UUIDField(db_index=True, default=uuid.uuid1, editable=False)),
                ('bus_number', models.CharField(db_index=True, max_length=255)),
                ('pos_serial_no', models.TextField(blank=True, max_length=255, null=True)),
                ('pos_dsn_number', models.CharField(blank=True, max_length=255, null=True)),
                ('gps_sim_image', models.TextField(blank=True, max_length=255, null=True)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
